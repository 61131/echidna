...
MunitResult 
test_select_min(const MunitParameter Parameters[], void *Fixture) {
    ECHIDNA *pContext;
    LL sParameters;
    PARAMETER *pValue;
    VALUE sResult;
    ...
    value_assign(&pValue->Value, TYPE_LREAL, 10.0);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, 0);
    ...
    munit_assert_uint64(sResult.Value.U64, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint32(sResult.Value.U32, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint16(sResult.Value.U16, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint8(sResult.Value.U8, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint64(sResult.Value.B64, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint32(sResult.Value.B32, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint16(sResult.Value.B16, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
    ...
    munit_assert_uint8(sResult.Value.B8, ==, 5);
    munit_assert_not_null(pValue = parameter_new(NULL));
    value_assign(&pValue->Value, TYPE_BOOL);
    munit_assert_int(ll_insert(&sParameters, pValue), ==, 0);
    munit_assert_int(standard_min(pContext, NULL, &sParameters, &sResult, NULL), ==, ERROR_PARAMETER_MISMATCH);
