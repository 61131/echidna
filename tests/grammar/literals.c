...
test_grammar_literals_time(const MunitParameter Parameters[], void *Fixture) {
    ...
    struct _TEST_LITERAL sValues[] = {
        ...
        { "T#14.7s", { .Double = 1.470E+04 } },
        { "T#14.7m", { .Double = 8.820E+05 } },
        { "T#14.7h", { .Double = 5.292E+07 } },
        { "t#14.7d", { .Double = 1.27008E+09 } },
        { "t#5d14h12m18s3.5ms", { .Double = 483138003.5 } },
        { "time#14.7s", { .Double = 1.470E+04 } },
        { "t#5d_14h_12m_18s_3.5ms", { .Double = 483138003.5 } },
        { "time#5d_14h_12m_18s_3.5ms", { .Double = 483138003.5 } },
    ...
    for(nIndex = 0;; ++nIndex) {
        ...
        if(!pValue->Source)
            break;
        snprintf(sLine, sizeof(sLine), "TYPE TEST: TIME := %s; END_TYPE", pValue->Source);
        if(test_parse(pContext, sLine) != 0)
            return MUNIT_FAIL;
        ...
        fprintf(stderr, "\"%s\" %g\n", pValue->Source, pValue->Value.Double);
